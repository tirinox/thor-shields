...
export default {
    ...
    mounted() {
        ...
        // Moving Stick
        const boxA = Bodies.rectangle(width / 2, height / 2, width / 4, 16, {
            isStatic: false
        });
        ...
        Events.on(boxA, "sleepEnd", console.log);
        ...
        const chain = Composites.chain(boxes, 0, 0, 0.1, 0.1, {
            dampening: 1,
            stiffness: 1,
        ...
        const jfPath = Vertices.fromPath(
